...
##############
# Product Name: Initialize-ECKPrereq-Alpha.ps1
...
# Script Version 2.2.9 - 05/07/2022 - changed logpath logic
        ...
        Try 
            {
                ...
                If ((Get-Module 'endpointcloudkit-Alpha' -ListAvailable).Name -eq 'EndpointCloudkit-Alpha')
                    {
                        Remove-module 'endpointcloudkit-Alpha' -ErrorAction SilentlyContinue
                        try 
                            {
                        ...
                        Try
                            {
                                ...
                                $Nupkg = "$ContentPath\$(($FileURI.split("/").split("#")[-1]).replace(".nupkg",".zip"))"
